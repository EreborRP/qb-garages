...
AutoEnterVehicleAfterTakingOutFromGarage = false
...
Garages = {
    ["motelgarage"] = {
        ...
        zone = {
            shape = {
                vector3(304.66, -329.25, 45.02),
                vector3(293.62, -359.53, 45.39),
                vector3(257.21, -345.05, 45.15),
                vector3(267.38, -316.57, 45.02),
            },
            minZ = 10,
            maxZ = 50
        },
        spawnPoints = {
            [0] = vector4(277.98, -336.43, 44.51, 70.39), 
        },
    },
    ["paletoSquare"] = {
        label = "Paleto Square",
        takeVehicle = vector3(158.22, 6591.5, 31.12),
        spawnPoint = vector4(158.22, 6591.5, 31.12, 354.85),
        putVehicle = vector3(158.22, 6591.5, 31.12),
        showBlip = true,
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
        ...
        zone = {
            shape = {
                vector3(146.45, 6635.62, 31.63),
                vector3(163.14, 6620.35, 31.87),
                vector3(164.31, 6565.91, 31.77),
                vector3(147.32, 6564.22, 31.96),
                vector3(110.01, 6600.9, 32.07),
            },
            minZ = 10,
            maxZ = 50
        },
        spawnPoints = {
            [0] = vector4(145.93, 6614.09, 31.41, 356.78), 
            [1] = vector4(151.2, 6609.02, 31.46, 355.66),  
            [2] = vector4(155.26, 6604.21, 31.46, 355.13),  
            [3] = vector4(159.99, 6600.05, 31.44, 2.21),   
            [4] = vector4(141.13, 6605.43, 31.44, 178.42), 
            [5] = vector4(145.75, 6602.27, 31.44, 182.31), 
            [6] = vector4(150.85, 6597.7, 31.44, 180.09),   
            [7] = vector4(155.57, 6592.49, 31.44, 176.33)
        },
    },
    -- ["sapcounsel"] = {
